...
<head>
    ...
    <title>Tambah Artikel - SDN 4 Jatilaba</title>
...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors duration-300">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-orange-100 text-sm sm:text-base">Bagikan informasi dan berita terbaru SDN 4 Jatilaba</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden">
                <div class="bg-gradient-to-r from-amber-50 to-orange-100 dark:from-gray-700 dark:to-gray-700 px-6 py-4 border-b border-amber-200 dark:border-gray-600">
                    <h2 class="text-xl font-bold text-gray-800 dark:text-white flex items-center">
                        <i class="fas fa-edit mr-2 text-amber-600 dark:text-amber-400"></i>
                ...
                <form action="{{ route('admin.artikel.store') }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8">
                    @csrf
                ...
                <div class="flex">
                    ...
                    <div class="text-sm text-amber-800 dark:text-amber-300">
                        ...
                        <ul class="list-none space-y-2 text-xs">
                            ...
                            <li class="flex items-start">
                                <i class="fas fa-check-circle text-green-500 mr-2 mt-0.5 flex-shrink-0"></i>
                                <span>Struktur isi artikel dengan paragraf yang jelas</span>
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-check-circle text-green-500 mr-2 mt-0.5 flex-shrink-0"></i>
                                <span>Sertakan gambar pendukung jika tersedia</span>
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-check-circle text-green-500 mr-2 mt-0.5 flex-shrink-0"></i>
                                <span>Periksa kembali tulisan sebelum dipublikasikan</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    function resetForm() {
        if (confirm('Apakah Anda yakin ingin mengatur ulang form? Semua data yang telah diisi akan hilang.')) {
            ...
            document.getElementById('imagePreviewContainer').classlection.add('hidden');
