<!-- Sidebar -->
<aside class="w-64 bg-white dark:bg-gray-800 text-gray-900 dark:text-white fixed h-full lg:relative lg:translate-x-0 transform -translate-x-full sidebar-transition z-50 shadow-lg lg:shadow-none"
    ...
    <nav class="mt-4 custom-scrollbar overflow-y-auto h-[calc(100vh-120px)]">
        ...
        <a href="{{ route('admin.artikel.index') }}" 
           class="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white transition-colors duration-200 {{ $activeMenu === 'berita' ? 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white' : '' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="{{ route('admin.pengumuman.index') }}" class="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white transition-colors duration-200">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
