...
<head>
  ...
  <title>Detail Prestasi - {{ $prestasi->judul }} - SDN 4 Jatilaba</title>
...
<body class="bg-gradient-to-br from-gray-50 via-cyan-50/20 to-gray-100 dark:from-gray-950 dark:via-cyan-950/20 dark:to-gray-900 transition-colors duration-300">
  ...
  <section class="hero-section hero-height" style="background-image: url('{{ asset('storage/' . $prestasi->gambar) }}');">
    ...
    <div class="relative z-10 h-full flex items-end pb-8 md:pb-12">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        <div class="portal-badge inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-cyan-100 text-sm font-semibold mb-4 shadow-lg" data-aos="fade-up" data-aos-delay="100">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
          </svg>
          Detail Prestasi SDN 4 Jatilaba
        </div>

        <div class="juara-badge absolute top-8 right-8" data-aos="fade-left" data-aos-delay="200">
          {{ $prestasi->juara }}
        </div>

        <h1 class="font-display text-4xl md:text-6xl font-bold text-white mb-4 leading-tight tracking-tight drop-shadow-[0_4px_6px_rgba(0,0,0,0.3)]" data-aos="fade-up" data-aos-delay="150">
          {{ $prestasi->judul }}
        </h1>

        <div class="flex flex-wrap gap-6 text-white/90 mb-4" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="font-medium">{{ $prestasi->tingkat }}</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
    <div class="grid md:grid-cols-3 gap-12">
      ...
      <div class="md:col-span-2" data-aos="fade-up" data-aos-delay="100">
        <div class="content-card rounded-3xl shadow-xl p-8 md:p-12 mb-8">
          <h2 class="section-title text-3xl font-bold text-gray-900 dark:text-white">
            Tentang Prestasi
          </h2>
        ...
        <div class="mt-8" data-aos="fade-up" data-aos-delay="200">
          <a href="{{ route('prestasi') }}" 
            ...
            <span class="text-lg">Kembali ke Galeri Prestasi</span>
          </a>
        </div>
      </div>

      <!-- Sidebar Info -->
      <div class="md:col-span-1" data-aos="fade-left" data-aos-delay="150">
        <div class="sticky top-8 space-y-6">
          
          <!-- Info Card -->
          <div class="content-card rounded-3xl shadow-xl p-6">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-6 pb-2 border-b border-gray-200 dark:border-gray-700">
              Informasi Detail
            </h3>
