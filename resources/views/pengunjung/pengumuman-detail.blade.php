...
<body class="gradient-bg text-gray-900 dark:text-gray-100 transition-colors duration-300">
  ...
  <main class="max-w-4xl mx-auto px-4 sm:px-6 py-10 md:py-14">
    <article class="article-card rounded-2xl overflow-hidden transition-all duration-500 hover:-translate-y-1"
      data-aos="fade-up">
      ...
      <div class="p-6 sm:p-8 md:p-10">
        ...
        <!-- Isi pengumuman -->
        <div class="article-content mt-6 leading-relaxed">
    ...
    <div class="mt-10 text-center" data-aos="fade-up" data-aos-delay="200">
      <a href="{{ url()->previous() }}"
        class="inline-flex items-center gap-3 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white px-8 py-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 font-semibold group">
