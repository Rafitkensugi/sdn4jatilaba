...
<head>
  ...
  <title>Galeri Prestasi - SDN 4 Jatilaba</title>
  ...
  <style>
    ...
    /* Dark mode styles for prestasi card */
    ...
    .prestasi-card:hover::after { opacity: 0.3; }
    .prestasi-card:hover {
    ...
    @media (max-width:640px){ .prestasi-content{ padding:1.5rem; } }
    ...
    .prestasi-content .text-gray-700 {
      color: #374151;
    }
    ...
    .dark .prestasi-content .text-gray-700 {
      color: #d1d5db;
    }
...
<body class="bg-gradient-to-br from-gray-50 via-cyan-50/20 to-gray-100 dark:from-gray-950 dark:via-cyan-950/20 dark:to-gray-900 transition-colors duration-300">
  ...
  <section id="home" class="hero-section py-20 md:py-32" style="background-image: url('{{ asset('images/hero.jpeg') }}');">
    ...
    <div class="relative z-10 text-center">
      <div class="portal-badge inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-cyan-100 text-sm font-semibold mb-8 shadow-lg" data-aos="fade-up" data-aos-delay="100">
        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path>
          <path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd"></path>
        </svg>
        Galeri Prestasi SDN 4 Jatilaba
      </div>
  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
    ...
    @if ($prestasis->isEmpty())
      <div class="empty-state rounded-3xl p-12 md:p-20 text-center max-w-2xl mx-auto relative z-10" data-aos="fade-up">
        ...
        <h3 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4 font-display">Belum Ada Prestasi</h3>
        <p class="text-gray-600 dark:text-gray-400 text-base md:text-lg leading-relaxed">
          Prestasi akan segera dipublikasikan. Tetap pantau halaman ini untuk pencapaian terbaru dari sekolah!
        </p>
      </div>
    @else
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
        @foreach ($prestasis as $prestasi)
          <div class="prestasi-card rounded-3xl shadow-xl overflow-hidden" data-aos="fade-up" data-aos-delay="{{ $loop->index * 80 }}">
            ...
            <div class="prestasi-content">
              <h2 class="prestasi-title text-2xl font-bold leading-tight">
                {{ $prestasi->judul }}
              </h2>

              <div class="space-y-3 mb-6">
                <div class="flex items-center text-gray-700 dark:text-gray-300">
                  <svg class="w-5 h-5 mr-3 text-cyan-500 dark:text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
