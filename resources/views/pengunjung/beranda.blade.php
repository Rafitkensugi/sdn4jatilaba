                    ...
                    <div class="p-4">
                        ...
                        <div class="hidden teacher-details">
                            <div class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                                ...
                                <p><span class="font-semibold">Aktif:</span> {{ $guru->aktif_sejak->format('Y') }}</p>
                                <p><span class="font-semibold">Jabatan:</span> {{ $guru->jabatan }}</p>
                                <p><span class="font-semibold">Status:</span> {{ $guru->status }}</p>
                                <p><span class="font-semibold">Domisili:</span> {{ $guru->domisili }}</p>
                            </div>
                        </div>
